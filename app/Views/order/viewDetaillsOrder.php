            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <select readonly class="form-select form-field" id="payment_method" name="payment_method">
                        ...
                        foreach ($methods as $method) {
                            ...
                            // Verificar si el valor coincide con $ord['quo_payment_method']
                            $selected = ($payment_method_id == $ord['quo_payment_method']) ? 'selected' : '';
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <textarea readonly class="form-control form-field" aria-label="With textarea"
                ...
                <div class="form-group">
                    ...
                    <textarea readonly class="form-control" id="comentarios" name="comments" rows="3">
                        <?php echo !empty($ord['quo_comments']) ? htmlspecialchars($ord['quo_comments']) : ''; ?>
                    </textarea>
                </div>
