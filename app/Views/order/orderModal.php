...
<div class="container d-flex">
    <div class="col-md-6">
        ...
        <button data-url="<?= generateUrl("Order","Order","consultGridArticles",['order'=>'3'],"ajax")?>"
            class="btn-grid btn btn-light">
            <img src="img/piezas.png" alt="" srcset="">
        </button>
        <button data-url="<?= generateUrl("Order","Order","consultGridArticles",['order'=>'4'],"ajax")?>"
            class="btn-grid btn btn-light">
            <img src="img/grid-alt.png" alt="" srcset="">
        </button>
        <button data-url="<?= generateUrl("Order","Order","consultGridArticles",['order'=>'6'],"ajax")?>"
            class="btn-grid btn btn-light">
            <img src="img/secciones.png" alt="" srcset="">
        </button>
        <button data-url="<?= generateUrl("Order","Order","consultGridArticles",['order'=>'table'],"ajax")?>"
            class="btn-grid btn btn-light">
    ...
    <div class="col-md-6 cardsDiv ">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text"><b>Descaripción: </b><?= $art['ar_desc']?></p>
