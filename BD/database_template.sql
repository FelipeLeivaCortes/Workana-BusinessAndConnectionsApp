...
--
-- Estructura de tabla para la tabla `extra_attributes_company`
--

CREATE TABLE `extra_attributes_company` (
  `c_attrs_id` int(11) NOT NULL,
  `c_id` int(11) DEFAULT NULL,
...
--
-- Indices de la tabla `extra_attributes_company`
--
ALTER TABLE `extra_attributes_company`
  ADD PRIMARY KEY (`c_attrs_id`),
  ADD KEY `c_id` (`c_id`);
...
--
-- Filtros para la tabla `extra_attributes_company`
--
ALTER TABLE `extra_attributes_company`
  ADD CONSTRAINT `extra_attributes_company_ibfk_1` FOREIGN KEY (`c_id`) REFERENCES `company` (`c_id`);
