...
-- Volcando estructura de base de datos para demosby1_bac
DROP DATABASE IF EXISTS `demoportalbusine_demosby2_bac`;
CREATE DATABASE IF NOT EXISTS `demoportalbusine_demosby2_bac` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `demoportalbusine_demosby2_bac`;

-- Volcando estructura para tabla demosby1_bac.action_permissions
CREATE TABLE IF NOT EXISTS `action_permissions` (
  ...
  PRIMARY KEY (`id`),
  KEY `m_id` (`m_id`,`rol_id`),
  KEY `rol_id` (`rol_id`),
  CONSTRAINT `action_permissions_ibfk_1` FOREIGN KEY (`rol_id`) REFERENCES `roles` (`rol_id`),
  CONSTRAINT `action_permissions_ibfk_2` FOREIGN KEY (`m_id`) REFERENCES `modules` (`m_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Volcando datos para la tabla demosby1_bac.action_permissions: ~0 rows (aproximadamente)
DELETE FROM `action_permissions`;

-- Volcando estructura para tabla demosby1_bac.articles
CREATE TABLE IF NOT EXISTS `articles` (
  ...
  KEY `sbcat_id` (`sbcat_id`),
  KEY `status_id` (`status_id`),
  CONSTRAINT `articles_ibfk_1` FOREIGN KEY (`cat_id`) REFERENCES `category` (`cat_id`),
  CONSTRAINT `articles_ibfk_2` FOREIGN KEY (`mt_id`) REFERENCES `measurement_type` (`mt_id`),
  CONSTRAINT `articles_ibfk_3` FOREIGN KEY (`color_id`) REFERENCES `colors` (`color_id`),
  CONSTRAINT `articles_ibfk_4` FOREIGN KEY (`sbcat_id`) REFERENCES `subcategory` (`sbcat_id`),
  CONSTRAINT `articles_ibfk_5` FOREIGN KEY (`status_id`) REFERENCES `status` (`status_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4;

-- Volcando datos para la tabla demosby1_bac.articles: ~5 rows (aproximadamente)
...
-- Volcando estructura para tabla demosby1_bac.category
...
-- Volcando datos para la tabla demosby1_bac.category: ~3 rows (aproximadamente)
...
-- Volcando estructura para tabla demosby1_bac.colors
...
-- Volcando datos para la tabla demosby1_bac.colors: ~8 rows (aproximadamente)
DELETE FROM `colors`;
...
-- Volcando estructura para tabla demosby1_bac.company
CREATE TABLE IF NOT EXISTS `company` (
  ...
  KEY `status_id` (`status_id`),
  KEY `s_id` (`s_id`),
  CONSTRAINT `company_ibfk_1` FOREIGN KEY (`id_subs`) REFERENCES `subscription` (`id_subs`),
  CONSTRAINT `company_ibfk_2` FOREIGN KEY (`tpi_id`) REFERENCES `types_industry` (`tpi_id`),
  CONSTRAINT `company_ibfk_3` FOREIGN KEY (`status_id`) REFERENCES `status` (`status_id`),
  CONSTRAINT `company_ibfk_4` FOREIGN KEY (`s_id`) REFERENCES `sellers` (`s_id`)
) ENGINE=InnoDB AUTO_INCREMENT=67 DEFAULT CHARSET=utf8mb4;

-- Volcando datos para la tabla demosby1_bac.company: ~10 rows (aproximadamente)
DELETE FROM `company`;
INSERT INTO `company` (`c_id`, `c_name`, `c_desc`, `c_num_nit`, `c_num_ver_nit`, `c_route_rut`, `c_route_cc_representant`, `c_chamber_commerce`, `c_form_inscription`, `c_certificate_bank`, `c_street`, `c_apartament`, `c_country`, `c_city`, `c_state`, `c_postal_code`, `c_shippingStreet`, `c_shippingApartament`, `c_shippingCountry`, `c_shippingCity`, `c_shippingState`, `c_shippingPostalcode`, `created_at`, `id_subs`, `tpi_id`, `status_id`, `s_id`) VALUES
	(1, 'Business And Connection', 'solutions technology', '3423421-323', NULL, NULL, NULL, NULL, NULL, NULL, 'CALLE 1 C #76 A 25', 'APARTAMENTO E 202', 'Colombia', 'CALI', 'Valle del Cauca', 760035, 'CALLE 1 C #76 A 25', 'APARTAMENTO E 202', 'Colombia', 'CALI', 'Valle del Cauca', 760035, '2023-06-20 19:30:42', NULL, 2, 1, NULL),
	...
	(55, 'Comercializadora e importadora el gran virrey SAS', 'a', '901.124.856-3', NULL, 'uploads/companies/company_55/rut/uploads_quotes_2_COD_2-Cotizacion-23-05-18.pdf', 'uploads/companies/company_55/chamber_of_commerce/uploads_quotes_2_COD_2-Cotizacion-23-05-18.pdf', 'uploads/companies/company_55/representative_cedula/uploads_quotes_2_COD_2-Cotizacion-23-05-18.pdf', 'uploads/companies/company_55/form_inscription/uploads_quotes_2_COD_2-Cotizacion-23-05-18.pdf', 'uploads/companies/company_55/certificate_bank/uploads_quotes_2_COD_2-Cotizacion-23-05-18.pdf', 'CALL2', '232|', 'Colombia', 'PUERTO RONDÓN', 'ARAUCA', 2032, 'CALL2', '232|', 'Colombia', 'PUERTO RONDÓN', 'ARAUCA', 2032, '2023-10-11 22:35:19', NULL, 2, 1, 2),
	...
	(62, 'SAVCO SAS', '', '900550514', NULL, 'uploads/companies/company_62/rut/3. Rut Savco sas.pdf', 'uploads/companies/company_62/chamber_of_commerce/2. Camara de Comercio 21092023.pdf', 'uploads/companies/company_62/representative_cedula/4. Cedula Represntante Legal.pdf', 'uploads/companies/company_62/form_inscription/2. Camara de Comercio 21092023.pdf', 'uploads/companies/company_62/certificate_bank/2. Camara de Comercio 21092023.pdf', NULL, NULL, 'Colombia', 'CHOCONTÁ', 'CUNDINAMARCA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2023-10-24 21:56:49', NULL, 5, 2, 5),
	...
	(64, 'IMCOLMEDICA SA', NULL, '860070078', NULL, 'uploads/companies/company_64/rut/ok.docx', 'uploads/companies/company_64/chamber_of_commerce/ok.docx', 'uploads/companies/company_64/representative_cedula/ok.docx', 'uploads/companies/company_64/form_inscription/ok.docx', 'uploads/companies/company_64/certificate_bank/ok.docx', NULL, NULL, 'Colombia', 'BOGOTA D.C.', 'BOGOTÁ', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2023-11-20 21:51:05', NULL, 14, 2, 4),
	...
	(66, 'Inversionaes Sandor', NULL, '79988969', NULL, 'uploads/companies/company_66/rut/Cuenta de cobro Bussiness & connection.doc', 'uploads/companies/company_66/chamber_of_commerce/Cuenta de cobro Bussiness & connection.doc', 'uploads/companies/company_66/representative_cedula/Cotización requerimientos portal Web Edwin Valencia(Business & Connection).doc', 'uploads/companies/company_66/form_inscription/Cotización requerimientos portal Web Edwin Valencia(Business & Connection).doc', 'uploads/companies/company_66/certificate_bank/Cotización requerimientos portal Web Edwin Valencia(Business & Connection).doc', NULL, NULL, 'Colombia', 'BOGOTA D.C.', 'BOGOTÁ', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2024-02-05 15:13:29', NULL, 4, 2, NULL);

-- Volcando estructura para tabla demosby1_bac.creditlimits
CREATE TABLE IF NOT EXISTS `creditlimits` (
  ...
  KEY `c_id` (`c_id`),
  CONSTRAINT `creditlimits_ibfk_1` FOREIGN KEY (`c_id`) REFERENCES `company` (`c_id`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8mb4;

-- Volcando datos para la tabla demosby1_bac.creditlimits: ~6 rows (aproximadamente)
...
-- Volcando estructura para tabla demosby1_bac.credittransactions
...
-- Volcando datos para la tabla demosby1_bac.credittransactions: ~0 rows (aproximadamente)
DELETE FROM `credittransactions`;

-- Volcando estructura para tabla demosby1_bac.customer_discounts
CREATE TABLE IF NOT EXISTS `customer_discounts` (
  ...
  PRIMARY KEY (`cd_id`),
  KEY `c_id` (`c_id`,`cat_id`,`sbcat_id`,`ar_id`,`gp_id`),
  KEY `cat_id` (`cat_id`),
  KEY `sbcat_id` (`sbcat_id`),
  KEY `gp_id` (`gp_id`),
  KEY `ar_id` (`ar_id`),
  CONSTRAINT `customer_discounts_ibfk_1` FOREIGN KEY (`c_id`) REFERENCES `company` (`c_id`),
  CONSTRAINT `customer_discounts_ibfk_2` FOREIGN KEY (`cat_id`) REFERENCES `category` (`cat_id`),
  CONSTRAINT `customer_discounts_ibfk_3` FOREIGN KEY (`sbcat_id`) REFERENCES `subcategory` (`sbcat_id`),
  CONSTRAINT `customer_discounts_ibfk_4` FOREIGN KEY (`gp_id`) REFERENCES `group_discounts` (`gp_id`),
  CONSTRAINT `customer_discounts_ibfk_5` FOREIGN KEY (`ar_id`) REFERENCES `articles` (`ar_id`)
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8mb4;

-- Volcando datos para la tabla demosby1_bac.customer_discounts: ~12 rows (aproximadamente)
...
-- Volcando estructura para tabla demosby1_bac.customer_payment_method
CREATE TABLE IF NOT EXISTS `customer_payment_method` (
  `customer_payment_id` int(11) NOT NULL AUTO_INCREMENT,
  `c_id` int(11) DEFAULT NULL,
  `payment_method_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`customer_payment_id`),
  KEY `c_id` (`c_id`,`payment_method_id`),
  KEY `payment_method_id` (`payment_method_id`),
  CONSTRAINT `customer_payment_method_ibfk_1` FOREIGN KEY (`c_id`) REFERENCES `company` (`c_id`),
  CONSTRAINT `customer_payment_method_ibfk_2` FOREIGN KEY (`payment_method_id`) REFERENCES `payment_methods` (`payment_method_id`)
) ENGINE=InnoDB AUTO_INCREMENT=83 DEFAULT CHARSET=utf8mb4;

-- Volcando datos para la tabla demosby1_bac.customer_payment_method: ~23 rows (aproximadamente)
...
-- Volcando estructura para tabla demosby1_bac.extra_attributes_articles
CREATE TABLE IF NOT EXISTS `extra_attributes_articles` (
  `art_attrs_id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`art_attrs_id`),
  KEY `ar_id` (`ar_id`),
  CONSTRAINT `extra_attributes_articles_ibfk_1` FOREIGN KEY (`ar_id`) REFERENCES `articles` (`ar_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Volcando datos para la tabla demosby1_bac.extra_attributes_articles: ~0 rows (aproximadamente)
DELETE FROM `extra_attributes_articles`;

-- Volcando estructura para tabla demosby1_bac.extra_attributes_company
CREATE TABLE IF NOT EXISTS `extra_attributes_company` (
  `c_attrs_id` int(11) NOT NULL AUTO_INCREMENT,
  `c_id` int(11) DEFAULT NULL,
  `attribute_name` varchar(255) DEFAULT NULL,
  `attribute_value` text,
  PRIMARY KEY (`c_attrs_id`),
  KEY `c_id` (`c_id`),
  CONSTRAINT `extra_attributes_company_ibfk_1` FOREIGN KEY (`c_id`) REFERENCES `company` (`c_id`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4;

-- Volcando datos para la tabla demosby1_bac.extra_attributes_company: ~8 rows (aproximadamente)
DELETE FROM `extra_attributes_company`;
...
-- Volcando estructura para tabla demosby1_bac.extra_attributes_order
CREATE TABLE IF NOT EXISTS `extra_attributes_order` (
  `order_attrs_id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`order_attrs_id`),
  KEY `order_id` (`order_id`),
  CONSTRAINT `extra_attributes_order_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `order` (`order_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Volcando datos para la tabla demosby1_bac.extra_attributes_order: ~0 rows (aproximadamente)
DELETE FROM `extra_attributes_order`;

-- Volcando estructura para tabla demosby1_bac.extra_attributes_quotes
CREATE TABLE IF NOT EXISTS `extra_attributes_quotes` (
  `quote_attrs_id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`quote_attrs_id`),
  KEY `quo_id` (`quo_id`),
  CONSTRAINT `extra_attributes_quotes_ibfk_1` FOREIGN KEY (`quo_id`) REFERENCES `quotes` (`quo_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Volcando datos para la tabla demosby1_bac.extra_attributes_quotes: ~0 rows (aproximadamente)
DELETE FROM `extra_attributes_quotes`;

-- Volcando estructura para tabla demosby1_bac.group_discounts
...
-- Volcando datos para la tabla demosby1_bac.group_discounts: ~8 rows (aproximadamente)
DELETE FROM `group_discounts`;
...
-- Volcando estructura para tabla demosby1_bac.measurement_type
...
-- Volcando datos para la tabla demosby1_bac.measurement_type: ~8 rows (aproximadamente)
...
-- Volcando estructura para tabla demosby1_bac.meeting
...
-- Volcando datos para la tabla demosby1_bac.meeting: ~0 rows (aproximadamente)
DELETE FROM `meeting`;
...
-- Volcando estructura para tabla demosby1_bac.meeting_attendees
CREATE TABLE IF NOT EXISTS `meeting_attendees` (
  `meet_att_id` int(11) NOT NULL AUTO_INCREMENT,
  `meeting_id` int(11) DEFAULT NULL,
  `u_id` int(11) DEFAULT NULL,
  `c_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`meet_att_id`),
  KEY `meeting_id` (`meeting_id`,`u_id`,`c_id`),
  KEY `meeting_company_ibfk_1` (`c_id`),
  KEY `meeting_users_ibfk_1` (`u_id`),
  CONSTRAINT `meeting_attendees_ibfk_1` FOREIGN KEY (`meeting_id`) REFERENCES `meeting` (`meeting_id`),
  CONSTRAINT `meeting_company_ibfk_1` FOREIGN KEY (`c_id`) REFERENCES `company` (`c_id`),
  CONSTRAINT `meeting_users_ibfk_1` FOREIGN KEY (`u_id`) REFERENCES `users` (`u_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4;

-- Volcando datos para la tabla demosby1_bac.meeting_attendees: ~0 rows (aproximadamente)
DELETE FROM `meeting_attendees`;
INSERT INTO `meeting_attendees` (`meet_att_id`, `meeting_id`, `u_id`, `c_id`) VALUES
	(1, 1, 9, 54);

-- Volcando estructura para tabla demosby1_bac.messages
...
-- Volcando datos para la tabla demosby1_bac.messages: ~10 rows (aproximadamente)
...
-- Volcando estructura para tabla demosby1_bac.modules
...
-- Volcando datos para la tabla demosby1_bac.modules: ~7 rows (aproximadamente)
DELETE FROM `modules`;
...
-- Volcando estructura para tabla demosby1_bac.order
CREATE TABLE IF NOT EXISTS `order` (
  ...
  CONSTRAINT `order_ibfk_1` FOREIGN KEY (`u_id`) REFERENCES `users` (`u_id`),
  CONSTRAINT `order_ibfk_2` FOREIGN KEY (`order_state_id`) REFERENCES `order_states` (`order_state_id`)
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8mb4;

-- Volcando datos para la tabla demosby1_bac.order: ~12 rows (aproximadamente)
DELETE FROM `order`;
...
-- Volcando estructura para tabla demosby1_bac.order_articles
...
-- Volcando datos para la tabla demosby1_bac.order_articles: ~24 rows (aproximadamente)
DELETE FROM `order_articles`;
...
-- Volcando estructura para tabla demosby1_bac.order_states
...
-- Volcando datos para la tabla demosby1_bac.order_states: ~9 rows (aproximadamente)
...
-- Volcando estructura para tabla demosby1_bac.partners
...
-- Volcando datos para la tabla demosby1_bac.partners: ~0 rows (aproximadamente)
DELETE FROM `partners`;

-- Volcando estructura para tabla demosby1_bac.payment_methods
...
-- Volcando datos para la tabla demosby1_bac.payment_methods: ~7 rows (aproximadamente)
...
-- Volcando estructura para tabla demosby1_bac.permissions
CREATE TABLE IF NOT EXISTS `permissions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `rol_id` int(11) DEFAULT NULL,
  `m_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `rol_id` (`rol_id`,`m_id`),
  KEY `m_id` (`m_id`),
  CONSTRAINT `permissions_ibfk_1` FOREIGN KEY (`rol_id`) REFERENCES `roles` (`rol_id`),
  CONSTRAINT `permissions_ibfk_2` FOREIGN KEY (`m_id`) REFERENCES `modules` (`m_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Volcando datos para la tabla demosby1_bac.permissions: ~0 rows (aproximadamente)
DELETE FROM `permissions`;

-- Volcando estructura para tabla demosby1_bac.prices
CREATE TABLE IF NOT EXISTS `prices` (
  ...
  KEY `ar_id` (`ar_id`),
  KEY `wh_id` (`wh_id`),
  CONSTRAINT `prices_ibfk_2` FOREIGN KEY (`ar_id`) REFERENCES `articles` (`ar_id`),
  CONSTRAINT `prices_ibfk_3` FOREIGN KEY (`wh_id`) REFERENCES `warehouse` (`wh_id`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8mb4;

-- Volcando datos para la tabla demosby1_bac.prices: ~5 rows (aproximadamente)
DELETE FROM `prices`;
...
-- Volcando estructura para tabla demosby1_bac.quotes
CREATE TABLE IF NOT EXISTS `quotes` (
  ...
  PRIMARY KEY (`quo_id`),
  KEY `u_id` (`u_id`),
  KEY `quote_state_id` (`quote_state_id`),
  CONSTRAINT `quotes_ibfk_1` FOREIGN KEY (`u_id`) REFERENCES `users` (`u_id`),
  CONSTRAINT `quotes_ibfk_2` FOREIGN KEY (`quote_state_id`) REFERENCES `quotes_states` (`quote_state_id`)
) ENGINE=InnoDB AUTO_INCREMENT=88 DEFAULT CHARSET=utf8mb4;

-- Volcando datos para la tabla demosby1_bac.quotes: ~11 rows (aproximadamente)
DELETE FROM `quotes`;
...
-- Volcando estructura para tabla demosby1_bac.quotes_states
CREATE TABLE IF NOT EXISTS `quotes_states` (
  `quote_state_id` int(11) NOT NULL AUTO_INCREMENT,
  `quote_state_name` varchar(50) NOT NULL,
  PRIMARY KEY (`quote_state_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4;

-- Volcando datos para la tabla demosby1_bac.quotes_states: ~2 rows (aproximadamente)
DELETE FROM `quotes_states`;
INSERT INTO `quotes_states` (`quote_state_id`, `quote_state_name`) VALUES
	(1, 'Valida'),
	(2, 'Invalida');

-- Volcando estructura para tabla demosby1_bac.quote_articles
CREATE TABLE IF NOT EXISTS `quote_articles` (
  `quoart_id` int(11) NOT NULL AUTO_INCREMENT,
  `quo_id` int(11) NOT NULL,
  `ar_id` int(11) NOT NULL,
  ...
  PRIMARY KEY (`quoart_id`),
  KEY `ar_id` (`ar_id`),
  KEY `quo_id` (`quo_id`),
  CONSTRAINT `quote_articles_ibfk_1` FOREIGN KEY (`quo_id`) REFERENCES `quotes` (`quo_id`)
) ENGINE=InnoDB AUTO_INCREMENT=104 DEFAULT CHARSET=utf8mb4;

-- Volcando datos para la tabla demosby1_bac.quote_articles: ~22 rows (aproximadamente)
DELETE FROM `quote_articles`;
...
-- Volcando estructura para tabla demosby1_bac.roles
...
-- Volcando datos para la tabla demosby1_bac.roles: ~4 rows (aproximadamente)
DELETE FROM `roles`;
...
-- Volcando estructura para tabla demosby1_bac.sellers
...
-- Volcando datos para la tabla demosby1_bac.sellers: ~6 rows (aproximadamente)
DELETE FROM `sellers`;
...
-- Volcando estructura para tabla demosby1_bac.settings
CREATE TABLE IF NOT EXISTS `settings` (
  ...
  PRIMARY KEY (`st_id`),
  KEY `u_id` (`u_id`),
  CONSTRAINT `settings_ibfk_1` FOREIGN KEY (`u_id`) REFERENCES `users` (`u_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Volcando datos para la tabla demosby1_bac.settings: ~0 rows (aproximadamente)
DELETE FROM `settings`;

-- Volcando estructura para tabla demosby1_bac.status
...
-- Volcando datos para la tabla demosby1_bac.status: ~4 rows (aproximadamente)
DELETE FROM `status`;
...
-- Volcando estructura para tabla demosby1_bac.stock
CREATE TABLE IF NOT EXISTS `stock` (
  ...
  KEY `ar_id` (`ar_id`),
  KEY `wh_id` (`wh_id`),
  CONSTRAINT `stock_ibfk_2` FOREIGN KEY (`ar_id`) REFERENCES `articles` (`ar_id`),
  CONSTRAINT `stock_ibfk_3` FOREIGN KEY (`wh_id`) REFERENCES `warehouse` (`wh_id`)
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8mb4;

-- Volcando datos para la tabla demosby1_bac.stock: ~5 rows (aproximadamente)
DELETE FROM `stock`;
...
-- Volcando estructura para tabla demosby1_bac.subcategory
CREATE TABLE IF NOT EXISTS `subcategory` (
  `sbcat_id` int(11) NOT NULL AUTO_INCREMENT,
  `sbcat_name` varchar(60) NOT NULL,
  `sbcat_desc` varchar(60) DEFAULT NULL,
  `cat_id` int(11) NOT NULL,
  PRIMARY KEY (`sbcat_id`),
  KEY `cat_id` (`cat_id`),
  CONSTRAINT `subcategory_ibfk_1` FOREIGN KEY (`cat_id`) REFERENCES `category` (`cat_id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4;

-- Volcando datos para la tabla demosby1_bac.subcategory: ~15 rows (aproximadamente)
...
-- Volcando estructura para tabla demosby1_bac.subscription
...
-- Volcando datos para la tabla demosby1_bac.subscription: ~0 rows (aproximadamente)
DELETE FROM `subscription`;
INSERT INTO `subscription` (`id_subs`, `subs_date_init`, `subs_date_end`) VALUES
	(13, '2023-07-17', '2024-07-17');

-- Volcando estructura para tabla demosby1_bac.tabla_municipios
...
-- Volcando datos para la tabla demosby1_bac.tabla_municipios: ~1.119 rows (aproximadamente)
DELETE FROM `tabla_municipios`;
...
-- Volcando estructura para tabla demosby1_bac.types_industry
CREATE TABLE IF NOT EXISTS `types_industry` (
  `tpi_id` int(11) NOT NULL AUTO_INCREMENT,
  `industry_name` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`tpi_id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4;

-- Volcando datos para la tabla demosby1_bac.types_industry: ~18 rows (aproximadamente)
DELETE FROM `types_industry`;
...
-- Volcando estructura para tabla demosby1_bac.users
CREATE TABLE IF NOT EXISTS `users` (
  ...
  KEY `c_id_2` (`c_id`),
  KEY `status_id` (`status_id`),
  CONSTRAINT `users_ibfk_1` FOREIGN KEY (`rol_id`) REFERENCES `roles` (`rol_id`),
  CONSTRAINT `users_ibfk_2` FOREIGN KEY (`c_id`) REFERENCES `company` (`c_id`),
  CONSTRAINT `users_ibfk_3` FOREIGN KEY (`status_id`) REFERENCES `status` (`status_id`)
) ENGINE=InnoDB AUTO_INCREMENT=120 DEFAULT CHARSET=utf8mb4;

-- Volcando datos para la tabla demosby1_bac.users: ~12 rows (aproximadamente)
DELETE FROM `users`;
INSERT INTO `users` (`u_id`, `u_name`, `u_lastname`, `u_phone`, `u_email`, `u_document`, `u_type_document`, `u_country`, `u_city`, `u_pass`, `u_code`, `rol_id`, `c_id`, `status_id`) VALUES
	...
	(86, 'Edwin Valencia', 'valencia', 2147483647, 'sluque@businessandconnection.com', 1144108604, 'Cedula de ciudadanía', 'Colombia', 'RIOSUCIO', '$2y$10$iAE/0burGF3ZckIwtOj6vu./aDf7QyhLmDjiWrzNhM8No96l6dxmu', '33f8139a62b50094', 2, 54, 1),
	...
	(119, 'Sandor', 'Luque Farfán', 312534567, 'sluque@misena.edu.co', 79988969, 'Cedula de ciudadania', 'Colombia', 'BOGOTA D.C.', '$2y$10$RNWkVePHpJRICO/YlYoj5eW3PMJq2hQJ3PxaKpZS2UoLhsNKjoTxm', NULL, 3, 66, 1);

-- Volcando estructura para tabla demosby1_bac.warehouse
CREATE TABLE IF NOT EXISTS `warehouse` (
  ...
  PRIMARY KEY (`wh_id`),
  KEY `c_id` (`c_id`),
  CONSTRAINT `warehouse_ibfk_1` FOREIGN KEY (`c_id`) REFERENCES `company` (`c_id`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb4;

-- Volcando datos para la tabla demosby1_bac.warehouse: ~3 rows (aproximadamente)
